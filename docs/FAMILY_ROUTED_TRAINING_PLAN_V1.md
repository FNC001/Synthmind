...
状态：全库划分和合成条件 Top-K 已完成；前驱体严格 Top-10 当前 74.42%、目标 80%，高成本优化进行中；生产默认仍关闭  
