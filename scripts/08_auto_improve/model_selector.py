...
def render_markdown(decision: Dict[str, Any]) -> str:
    ...
    lines = [
        "# synthmind Model Selection Decision",
        "",
        "## Decision",
        "",
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Conservatively select synthmind Stage2/Stage3/Stage35 default and optional modes.")
