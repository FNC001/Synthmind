...
DEFAULT_OUTPUT_DIR = Path("outputs/auto_improve/synthmind_auto_v1_20260612")
...
def render_registry_markdown(records: Dict[str, Any]) -> str:
    ...
    lines = [
        "# synthmind Auto Improvement Metrics Registry",
        "",
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Build a normalized synthmind Stage2/Stage3/Stage35 metrics registry.")
