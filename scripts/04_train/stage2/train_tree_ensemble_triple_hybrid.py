...
def _default_project_root() -> Path:
    return Path("/Users/wyc/synthmind").expanduser().resolve()
...
def main() -> None:
    ...
    parser.add_argument(
        "--input_dir",
        type=str,
        default="/Users/wyc/synthmind/data/interim/generative/stage2_setpred_dataset/triple_hybrid/gold_only",
    )
    parser.add_argument(
        "--run_dir",
        type=str,
        default="/Users/wyc/synthmind/runs/stage2/tree_ensemble_triple_hybrid_commonized_v1",
    )
