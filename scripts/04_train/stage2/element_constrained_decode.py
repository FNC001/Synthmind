...
def main() -> None:
    ...
    parser.add_argument("--model_path", type=str,
                        default="/Users/wyc/synthmind/runs/stage2/gflownet_joint_rerank_hybrid_gold_only_v1/best_model.pt")
    parser.add_argument("--input_dir", type=str,
                        default="/Users/wyc/synthmind/data/interim/generative/stage2_gflownet_dataset/hybrid/gold_only")
    parser.add_argument("--output_dir", type=str,
                        default="/Users/wyc/synthmind/runs/stage2/gflownet_element_constrained_v1")
