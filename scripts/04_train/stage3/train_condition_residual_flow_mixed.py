...
_PROJECT_CANDIDATES = [
    _CURRENT_FILE.parents[3],  # /Users/wyc/synthmind
    _PathForBootstrap("/Users/wyc/synthmind"),
]
...
DEFAULT_PROJECT_ROOT = Path("/Users/wyc/synthmind")
DEFAULT_RUN_ROOT = Path("/Users/wyc/synthmind/runs/stage3/train_condition_residual_flow_mixed")
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--input_mode", type=str, default="/Users/wyc/synthmind")
    p.add_argument("--input_dir", type=str, default="/Users/wyc/synthmind/data/interim/generative/stage3_condition_dataset/hybrid_mixed_v1")
    ...
    p.add_argument("--baseline_ckpt", type=str, default="/Users/wyc/synthmind/runs/stage3/stage3_baseline_commonized_v1/best_model.pkl")
    p.add_argument("--run_dir", type=str, default="/Users/wyc/synthmind/runs/stage3/train_condition_residual_flow_mixed/gold_only")
