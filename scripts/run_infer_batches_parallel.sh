...
# ============================================================
# synthmind Parallel Batch Inference Runner
#
# Purpose:
...
#
# Examples:
#   bash scripts/run_infer_batches_parallel.sh /Users/wyc/synthmind cpu
#
#   N_JOBS=4 bash scripts/run_infer_batches_parallel.sh /Users/wyc/synthmind cpu
#
#   FORCE=1 N_JOBS=4 bash scripts/run_infer_batches_parallel.sh /Users/wyc/synthmind cpu
#
# Env options:
#   FORCE=0|1
#   N_JOBS=2
...
print_section "synthmind Parallel Batch Inference"
...
echo
echo "============================================================"
echo "[DONE] synthmind parallel batch inference completed"
echo "============================================================"
