...
def main() -> None:
    ...
    parser.add_argument(
        "--stage2_gold",
        type=str,
        default="/Users/wyc/synthmind/data/interim/refined/structdesc_refined/stage2_gold.jsonl",
    )
    parser.add_argument(
        "--stage2_relaxed",
        type=str,
        default="/Users/wyc/synthmind/data/interim/refined/structdesc_refined/stage2_train_relaxed.jsonl",
    )
    parser.add_argument(
        "--stage3_gold",
        type=str,
        default="/Users/wyc/synthmind/data/interim/refined/structdesc_refined/stage3_gold.jsonl",
    )
    parser.add_argument(
        "--stage3_relaxed",
        type=str,
        default="/Users/wyc/synthmind/data/interim/refined/structdesc_refined/stage3_train_relaxed.jsonl",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
