...
def main() -> None:
    ...
    parser.add_argument("--base_dir", type=str, default="/Users/wyc/synthmind/data", help="Base data directory.")
    parser.add_argument("--input_dir", type=str, default="/Users/wyc/synthmind/data/interim/splits/structdesc_splits", help="Directory containing stage2 split jsonl files.")
    parser.add_argument("--output_dir", type=str, default="", help="Optional explicit output directory. If omitted, defaults to base_dir/interim/graph_cache/chgnet_stage2")
    ...
    parser.add_argument("--precursor_vocab_json", type=str, default="/Users/wyc/synthmind/data/interim/features/structdesc_features/meta/precursor_vocab.json", help="Fixed precursor vocab json. If missing, falls back to building from the selected train split.")
