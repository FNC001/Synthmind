...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build CHGNet-ready stage3 cache with train_mode-aware split selection.")
    parser.add_argument(
        "--base_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional explicit output directory. If omitted, defaults to base_dir/interim/graph_cache/chgnet_stage3/<train_mode>.",
    )
    parser.add_argument(
        "--train_mode",
        type=str,
    ...
    if args.output_dir:
        ...
        output_dir = base_dir / "interim" / "graph_cache" / "chgnet_stage3" / args.train_mode
