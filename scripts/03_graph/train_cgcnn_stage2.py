...
def main() -> None:
    ...
    parser.add_argument("--cache_dir", type=str, default="/Users/wyc/synthmind/data/interim/graph_cache/cgcnn_stage2")
    parser.add_argument("--run_dir", type=str, default="/Users/wyc/synthmind/runs/graph_models/cgcnn_stage2_multilabel")
