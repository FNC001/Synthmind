...
# ============================================================
# synthmind Train Models Pipeline
#
# Purpose:
#   Train official synthmind production models only.
#
...
#   1) bash scripts/run_prepare_training_data.sh /Users/wyc/synthmind cpu
#   2) bash scripts/run_benchmark_models.sh /Users/wyc/synthmind cpu
#   3) bash scripts/run_train_models.sh /Users/wyc/synthmind cpu
#   4) bash scripts/run_inference_pipeline.sh /Users/wyc/synthmind cpu
#
# Usage:
#   bash scripts/run_train_models.sh [PROJECT_ROOT] [DEVICE]
#
# Examples:
#   bash scripts/run_train_models.sh /Users/wyc/synthmind cpu
#
#   FORCE=1 bash scripts/run_train_models.sh /Users/wyc/synthmind cpu
#
...
print_section "synthmind Train Models"
...
echo
echo "============================================================"
echo "[DONE] synthmind train models completed"
echo "============================================================"
