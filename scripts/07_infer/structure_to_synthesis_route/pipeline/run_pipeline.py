...
from src import steps_common
from src import steps_stage2
from src import steps_stage3
from src import steps_stage35
from src import steps_final
from src import steps_reliability
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Structure-to-synthesis route inference pipeline_v3."
    )
    ...
    print("============================================================")
    print("Structure-to-synthesis pipeline_v3")
