...
输入
----
- infer_hybrid_csv: 例如 /Users/wyc/synthmind/infer_runs/demo1/hybrid_stage2/stage2_test_hybrid.csv
- template_dir:     训练时的 GFlowNet 数据目录，例如
                    /Users/wyc/synthmind/data/interim/generative/stage2_gflownet_dataset/hybrid/gold_only
