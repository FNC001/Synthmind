...
def build_stage3_conditioned_table(r):
    ...
    r.run([
        "python",
        r.project_root / "scripts/07_infer/structure_to_synthesis_route/pipeline/src/05c_build_stage3_conditioned_feature_table_infer.py",
...
def run_stage3_flow(r):
    ...
    r.run([
        "python",
        r.route_scripts_dir / "pipeline/src/13_run_stage3_infer_mixture_flow_conditioned.py",
...
def run_stage3_lgbm(r):
    ...
    cmd = [
        "python",
        r.route_scripts_dir / "pipeline/src/13b_run_stage3_infer_lgbm_quantile.py",
        "--conditioned_x_csv", r.outputs["stage3_conditioned_x"],
        "--schema_json", s["schema_json"],
        "--output_dir", out_dir,
