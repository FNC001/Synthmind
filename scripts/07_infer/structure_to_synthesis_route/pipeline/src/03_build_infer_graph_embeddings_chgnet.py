...
python 03_build_infer_graph_embeddings_chgnet.py \
  --infer_jsonl /Users/wyc/synthmind/infer_runs/demo1/infer_split/infer.jsonl \
  --work_dir /Users/wyc/synthmind/infer_runs/demo1
...
def main() -> None:
    ...
    parser.add_argument("--project_root", type=str, default="/Users/wyc/synthmind")
    parser.add_argument(
        "--precursor_vocab_json",
        type=str,
        default="/Users/wyc/synthmind/data/interim/graph_cache/chgnet_stage2/gold_only/precursor_vocab.json",
    )
