...
# ============================================================
# synthmind Benchmark Models Runner
#
# Purpose:
...
#
# Examples:
#   bash scripts/run_benchmark_models.sh /Users/wyc/synthmind cpu
#
#   FORCE=1 bash scripts/run_benchmark_models.sh /Users/wyc/synthmind cpu
#
#   FORCE=1 RUN_STAGE2_TREE=0 bash scripts/run_benchmark_models.sh /Users/wyc/synthmind cpu
#
#   FORCE=1 RUN_STAGE3_HCNAF=1 bash scripts/run_benchmark_models.sh /Users/wyc/synthmind cpu
#
# Notes:
...
print_section "synthmind Benchmark Models"
...
echo
echo "============================================================"
echo "[DONE] synthmind benchmark models completed"
echo "============================================================"
