...
RUN="$ROOT/runs/canonical_v1/stage2_matscibert_qwen3_aligned_ensemble_s8515"
BASE="$ROOT/runs/canonical_v1/stage2_s8502_top10_s8494_depth_s8504/val_candidates.jsonl"
SCORE_A="$ROOT/runs/canonical_v1/stage2_matscibert_s8502_aligned_s8514/val_scores.npz"
SCORE_B="$ROOT/runs/canonical_v1/stage2_qwen3_1p7b_exact_s8505/val_scores_hashed.npz"

mkdir -p "$RUN"
cd "$ROOT/code"
export PYTHONPATH=.

/root/miniconda3/bin/python3 training/family/evaluate_stage2_score_ensemble_grid.py \
  --input_dir "$DATA" \
