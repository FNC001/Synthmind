...
def main() -> None:
    ...
    ap.add_argument("--temp_model_dir", type=str,
                    default="runs/stage3/lgbm_quantile_ensemble_v2_fulldata")
    ap.add_argument("--time_model_dir", type=str,
                    default="runs/stage3/lgbm_quantile_ensemble_v2_fulldata")
    ap.add_argument("--atm_model", type=str,
                    default="runs/stage3/lgbm_atmosphere_classifier_v1/model_atmosphere_binary_final.txt")
    ap.add_argument("--time_bucket_model", type=str,
                    default="runs/stage3/lgbm_time_bucket_classifier_v1/model_time_bucket.txt")
