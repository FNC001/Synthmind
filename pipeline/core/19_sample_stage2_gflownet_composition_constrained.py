...
def main() -> None:
    ...
    parser.add_argument(
        "--input_dir",
        type=str,
        default="data/interim/generative/stage2_gflownet_dataset/hybrid",
    )
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="runs/stage2/gflownet_joint_rerank_hybrid_gold_only_v1/best_model.pt",
    )
    parser.add_argument(
        "--split",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="outputs/stage2/gflownet_samples_test",
    )
