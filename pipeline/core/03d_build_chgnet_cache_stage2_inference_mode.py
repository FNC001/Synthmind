...
def main() -> None:
    ...
    parser.add_argument("--input_dir", type=str, default="data/interim/splits/structdesc_splits", help="Directory containing stage2 split jsonl files.")
    ...
    parser.add_argument("--precursor_vocab_json", type=str, default="data/interim/features/structdesc_features/meta/precursor_vocab.json", help="Fixed precursor vocab json. If missing, falls back to building from the selected train split.")
