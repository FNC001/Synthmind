...
依赖
----
- pipeline/core/03d_build_chgnet_cache_stage2_inference_mode.py
- pipeline/core/export_chgnet_stage2_embeddings.py

推荐用法
--------
python 03_build_infer_graph_embeddings_chgnet.py \
  --infer_jsonl data/interim/infer/demo1/split/infer.jsonl \
  --work_dir data/interim/infer/demo1
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="data/interim/graph_cache/chgnet_stage2/gold_only/precursor_vocab.json",
    )
    ...
    chgnet_cache_script = project_root / "pipeline/core/03d_build_chgnet_cache_stage2_inference_mode.py"
    ...
    export_script = project_root / "pipeline/core/export_chgnet_stage2_embeddings.py"
